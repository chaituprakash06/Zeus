...
# Below code taken from initial repo, to be amended for fine-tuning and custom few-shot prompting.
                        ...
                        "content": [
                            {
                                ...
                                "source": {
                                    ...
                                    "data": get_base64_encoded_image("/training_images/Image_1.png")
                                }
                            },
                            {
                                "type": "text",
                        ...
                        "content": [
                            {
                                ...
                                "source": {
                                    "type": "base64",
                                    "media_type": "image/png",
                                    "data": get_base64_encoded_image("/training_images/Image_2.png")
                                }
                            },
                            {
                                "type": "text",
                        ...
                        "content": [
                            {
                                ...
                                "source": {
                                    "type": "base64",
                                    "media_type": "image/png",
                                    "data": get_base64_encoded_image("/training_images/Image_3.png")
                                }
                            },
                            {
                                "type": "text",
        ...
        for action in instructions["actions"]:
            ...
            if action_type == "mouse_click":
                ...
                if key:
                    ...
                    self.log_action(f"Holding key: {key}")
            elif action_type == "keyup":
                key = action.get("key")
                if key:
                    pyautogui.keyUp(key)
                    self.log_action(f"Released key: {key}")
